...
class StreamTasksTest {
    ...
    void removeGreaterThanProvided(List<Integer> integers, List<Integer> integersWithoutGreaterThanProvided) {
        //when
        List<Integer> providedIntegers = streamTasks.removeGreaterThanProvidedMaxNumber(integers, 5);
        //then
    ...
    private static Stream<Arguments> argumentsForRemoveGreaterThanProvided() {
        return Stream.of(
                Arguments.of(List.of(), List.of()),
                Arguments.of(List.of(1, 2, 3, 4, 5), List.of(1, 2, 3, 4, 5, 6, 7, 8)),
